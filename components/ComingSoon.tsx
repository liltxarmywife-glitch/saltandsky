...
// Shared coming-soon holding page. Rendered directly at "/" and at "/coming-soon"
// so the homepage never depends on the proxy rewrite (which Vercel's static edge
// cache was bypassing). Design and copy unchanged.
